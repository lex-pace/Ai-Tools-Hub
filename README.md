# AI Tools Hub -- AI Tools 搜索聚合平台

AI Tools Hub 是一个面向 AI 领域的工具/工具搜索聚合平台，支持从 GitHub、Gitee 等代码托管平台自动采集 AI 相关项目数据，提供全文搜索、智能推荐、分类浏览、用户系统等核心功能。
...
```bash
# 1. 克隆项目
git clone <repo-url> && cd ai-tools-hub
...
│   │   │   └── register/       # 注册页
│   │   ├── components/         # React 组件
│   │   │   ├── home/           # 首页组件（HeroSearch/ToolCard/CategoryGrid）
...
| 工具 | `GET /api/v1/tools` | 获取工具列表 |
| 工具 | `GET /api/v1/tools/{id}` | 获取工具详情 |
